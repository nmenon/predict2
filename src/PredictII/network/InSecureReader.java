 ...
 */
public class InSecureReader extends SecureReader
{

    protected SuperMessage de (String input) throws Exception
    {
        input = input.trim ();
        SuperMessage su = new SuperMessage (input);
         return su;
    }

    public InSecureReader (DataInputStream inputR, logger log, String ID)
    {
        super ();
        in = inputR;
        this.ID = ID;
