...
class personalInfoGet
{
    ...
    public personalInfoGet (String ServerIp, int ServerPort, String UserName) throws Exception
    {
        ...
        String SQL_Query =
            ("Select ADDRESS, mailID,MoneyBalance from PERSONALINFORMATION where USERNAME='" +
             UserName + "'");
    ...
    public static void main (String[]args) throws Exception
    {
        ...
        try
        {
            personalInfoGet a = new personalInfoGet (ServerIp, ServerPort, args[0]);
        }
        catch (Exception e)
        {
            e.printStackTrace ();
