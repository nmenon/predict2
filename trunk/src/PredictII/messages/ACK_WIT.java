...
//Source file: Y:/E-Cash-Project/TestBed/development/messages/ACK_WIT.java
 ...
 */
public class ACK_WIT extends AckMaster implements Message
{
    ...
    public ACK_WIT (String IpString) throws Exception
    {
        super (IpString);
    }
    public ACK_WIT (String R, String K, String I) throws Exception
    {
        super (R, K, I);
    }
    ...
    */
    ...
    public static void main (String[]args) throws Exception
    {
        try
        {
            ACK_WIT n = new ACK_WIT (args[0]);
             System.out.println ("RAK=" + n.getRAK () + "\nK2=" + n.getK2 () +
                                 "\n IDENTIFIER=" + n.getIDENTIFIER ());
            ACK_WIT m = new ACK_WIT ("aaaa", "bbbb", "cccc");
