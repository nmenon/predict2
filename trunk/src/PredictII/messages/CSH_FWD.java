...
//Source file: Y:/E-Cash-Project/TestBed/development/messages/CSH_FWD.java
 ...
 * Citizen -> Merchant
 * That the cash is forwarded for deposit
 * 
 * IDENTIFIER, AMOUNT, RTT, RWT, TIMESTAMP
 */
public class CSH_FWD extends CashMaster implements Message
{
    ...
    * @author 
    * @version 
    * @roseuid 3B9A043000CC
    */
    public CSH_FWD ()
    {
        super ();
    }
    public CSH_FWD (String I, Float A, Long RT, Long RW, Long T) throws Exception
    {
        super (I, A, RT, RW, T);
    }
    public CSH_FWD (String Ip) throws Exception
    {
        super (Ip);
    }
    ...
    */
    ...
    public static void main (String[]args) throws Exception
    {
        ...
        CSH_FWD Jada1 = new CSH_FWD (Jada.toString ());
        ...
        CSH_FWD Jada21 = new CSH_FWD ("Helo dear", f, a, b, c);
