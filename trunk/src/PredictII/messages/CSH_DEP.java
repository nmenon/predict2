...
//Source file: Y:/E-Cash-Project/TestBed/development/messages/CSH_DEP.java
 ...
 * Merchant -> ZoneServer_Merchant
 * And this is to deposit the cash token that the Merchant has recieved
 * 
 * IDENTIFIER, AMOUNT, RTT, RWT, TIMESTAMP
 */
public class CSH_DEP extends CashMaster implements Message
{
    ...
    */
    ...
    public CSH_DEP (String I, Float A, Long RT, Long RW, Long T) throws Exception
    {
        super (I, A, RT, RW, T);
    }
    public CSH_DEP (String Ip) throws Exception
    {
        super (Ip);
    }
    ...
    */
    ...
    public static void main (String[]args) throws Exception
    {
        ...
        CSH_DEP Jada1 = new CSH_DEP (Jada.toString ());
        ...
        CSH_DEP Jada21 = new CSH_DEP ("Helo dear", f, a, b, c);
